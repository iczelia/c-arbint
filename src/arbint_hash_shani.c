...
void arbint_sha256_compress_shani(uint32_t state[8], const uint8_t block[64]) {
  ...
  tmp = _mm_add_epi32(
      msg0, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[0]));
  ...
  tmp = _mm_add_epi32(
      msg1, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[4]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  ...
  tmp = _mm_add_epi32(
      msg2, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[8]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  ...
  tmp = _mm_add_epi32(
      msg3, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[12]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  ...
  /*  Rounds 16-19  */
  tmp = _mm_add_epi32(
      msg0, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[16]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  ...
  /*  Rounds 20-23  */
  tmp = _mm_add_epi32(
      msg1, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[20]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  ...
  /*  Rounds 24-27  */
  tmp = _mm_add_epi32(
      msg2, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[24]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  ...
  /*  Rounds 28-31  */
  tmp = _mm_add_epi32(
      msg3, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[28]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg0 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 32-35  */
  tmp = _mm_add_epi32(
      msg0, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[32]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg1 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 36-39  */
  tmp = _mm_add_epi32(
      msg1, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[36]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg2 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 40-43  */
  tmp = _mm_add_epi32(
      msg2, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[40]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg3 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 44-47  */
  tmp = _mm_add_epi32(
      msg3, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[44]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg0 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 48-51  */
  tmp = _mm_add_epi32(
      msg0, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[48]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg1 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 52-55  */
  tmp = _mm_add_epi32(
      msg1, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[52]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg2 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 56-59  */
  tmp = _mm_add_epi32(
      msg2, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[56]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
  msg3 = _mm_sha256msg2_epu32(
  ...
  /*  Rounds 60-63  */
  tmp = _mm_add_epi32(
      msg3, _mm_loadu_si128((const __m128i *) &arbint_sha256_K_aligned[60]));
  state1 = _mm_sha256rnds2_epu32(state1, state0, tmp);
  tmp = _mm_shuffle_epi32(tmp, 0x0E);
  state0 = _mm_sha256rnds2_epu32(state0, state1, tmp);
